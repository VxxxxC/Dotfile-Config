...
vim.g.projects_dir = vim.env.HOME .. "/Desktop/.Desktop/dev/project"
vim.g.personal_projects_dir = vim.g.projects_dir .. "/Personal"
vim.g.work_projects_dir = vim.g.projects_dir .. "/Work"
vim.g.open_source_projects_dir = vim.g.projects_dir .. "/OpenSource"

local folder_icon = require("config.theme").symbol_kinds.Folder
...
function M.render()
  ...
  if vim.api.nvim_win_get_width(0) < math.floor(vim.o.columns / 3) then
    ...
    local special_dirs = {
      ...
      HOME = vim.env.HOME,
      WORK = vim.g.work_projects_dir,
      PERSONAL = vim.g.personal_projects_dir,
      OPEN_SOURCE = vim.g.open_source_projects_dir,
    }
