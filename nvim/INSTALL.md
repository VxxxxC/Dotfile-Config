...
- [x] install lazy.vim
- [x] install colorscheme
- [x] keymap config
- [x] neovim settings/options
- [x] snacks.nvim

## Plugins for setting up

- [x] treesitter
- [x] neovim/nvim-lspconfig
- [x] hrsh7th/nvim-cmp
- [x] hrsh7th/cmp-nvim-lsp
- [x] LuaSnip (auto-snippets)
- [x] conform (formatter)
- [x] lua-fzf (fuzzy finder)
- [x] oil.nvim (pop-up file explorer)
- [x] mini-file (file explorer)
